...
const interacedAudios = [new Audio(), new Audio(), new Audio()];
interacedAudios[0].autoplay = true;
interacedAudios[1].autoplay = true;
interacedAudios[2].autoplay = true;

window.addEventListener("click", () => {
	console.log("click");
	interacedAudios[0].src = `data:audio/mpeg;base64,`;
	interacedAudios[1].src = `data:audio/mpeg;base64,`;
	interacedAudios[2].src = `data:audio/mpeg;base64,`;
});

function playEffect(fileName, volume, { start = 0, duration = -1 } = {}) {
	const audio = interacedAudios.find((x) => x.paused);
	console.log(audio);
	if (!audio) {
		return;
	}

	audio.src = `/static/effects/${fileName}.mp3`;
